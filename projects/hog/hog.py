...
def free_bacon(opponent_score):
    ...
    # BEGIN PROBLEM 2
    nlist = [int(x) for x in str(opponent_score)]

    if opponent_score >= 10:
        return max (nlist) + 1
    elif opponent_score <10:
        return max (0, opponent_score) +1
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice= six_sided):
    ...
    if num_rolls == 0:
        ...
        if is_prime(turn_score):
            ...
            return when_pigs_fly(turn_score, num_rolls)
        return when_pigs_fly(turn_score, num_rolls)
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            strat = strategy0(score0, score1)
            if strat == -1:
                dice_swapped = not dice_swapped
                select_dice(score0, score1, dice_swapped)
                score0 += 1
            else:
                score0 += take_turn(strat, score1, select_dice(score0, score1, dice_swapped))
        else:
            strat = strategy1(score1, score0)
            if strat == -1:
                dice_swapped = not dice_swapped
                select_dice(score1, score0, dice_swapped)
                score1 += 1
            else:
                score1 += take_turn(strat, score0, select_dice(score0, score1, dice_swapped))
...
def check_strategy(strategy, goal=GOAL_SCORE):
    ...
    while score < goal:
        ...
        while opponent_score < goal:
            if check_strategy_roll(score, opponent_score, strategy(score, opponent_score))== AssertionError:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for rolls in range (1,11):
        temp = make_averaged(roll_dice)(rolls, dice)
        max1 = max(max1,temp)
        if temp >= max1:
            position = rolls
    return position
...
def run_experiments():
    ...
    if True:  # Change to False when done finding max_scoring_num_rolls
        ...
        print('Max scoring num rolls for re-rolled dice:', max_scoring_num_rolls(four_sided))
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if bacon >= margin:
        return 0
    if is_prime(bacon):
        if hogtimus_prime(bacon) >= margin:
            return 0
    return num_rolls
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 10
    bacon= free_bacon(opponent_score)
    bacon2= score + hogtimus_prime(bacon)
    if opponent_score == 2* bacon2:
        return 0
    elif bacon2 == 2* opponent_score:
        return num_rolls
    else: 
        return bacon_strategy(score, opponent_score, 8, 6)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    return swap_strategy(score, opponent_score, 6 , 9)
    # END PROBLEM 11
